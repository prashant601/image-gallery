...
const footer = () => {
    return (
        <footer className="bg-white pt-4 pb-8 xl:pt-8">
            ...
            <a href="https://www.linkedin.com/in/prashant-singh-2ba4861a7/">
            ...
            <a href="https://www.facebook.com/people/Prashant-Singh/100032801831651/">
        ...
        <div className=" text-2xl text-center pt-10 text-purple-800 sm:pt-12 flex items-center justify-center">
